...
public class regex {
    ...
    public static void main(String[] args) {
        ...
        pattern = Pattern.compile("(?=)[^\\d$][^MNDZmndz]{6,}");
        ...
        pattern = Pattern.compile("^(?=.*00)[\\w\\.]{10,}@gmail\\.com");
        ...
        pattern = Pattern.compile("(https?:\\/\\/)?(www\\.)?(?=.*lord(-|.?))(?=.*kechin(-|.?))(?=.*mendez(-|.?)).+\\.com?");
